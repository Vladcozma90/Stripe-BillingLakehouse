...
def _build_config(env: EnvConfig) -> dict[str, str]:
    return {
        ...
        "silver_dq_path": f"{env.curated_base_path}/{env.project}/stripe_subscription_items/s_dq_stripe_subscription_items",
        "silver_quarantine_path": f"{env.curated_base_path}/{env.project}/stripe_subscription_items/s_quarantine_stripe_subscription_items",
        "silver_current_path": f"{env.curated_base_path}/{env.project}/stripe_subscription_items/s_current_stripe_subscription_items",
    }
