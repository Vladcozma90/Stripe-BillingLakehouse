...
from src.pipelines.silver.silver_stripe_subscriptions import run_silver_stripe_subscriptions
...
def job_run_silver_stripe_subscriptions() -> None:
    ...
    try:
        run_silver_stripe_subscriptions(spark=spark, env=env)
...
if __name__ == '__main__':
    job_run_silver_stripe_subscriptions()
