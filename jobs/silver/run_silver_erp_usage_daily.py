...
from src.pipelines.silver.silver_erp_usage_daily import run_silver_erp_usage_daily
...
def job_run_silver_erp_usage_daily() -> None:
    ...
    try:
        run_silver_erp_usage_daily(spark=spark, env=env)
