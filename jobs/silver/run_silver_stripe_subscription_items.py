...
from src.pipelines.silver.silver_stripe_subscription_items import run_silver_stripe_subscription_items
...
def job_run_silver_stripe_subscription_items() -> None:
    ...
    try:
        run_silver_stripe_subscription_items(spark=spark, env=env)
...
if __name__ == '__main__':
    job_run_silver_stripe_subscription_items()
