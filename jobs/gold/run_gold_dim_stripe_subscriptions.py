...
from pipelines.gold.gold_dim_subscriptions import run_gold_dim_subscriptions
...
def job_run_gold_dim_subscriptions() -> None:
    ...
    try:
        run_gold_dim_subscriptions(spark=spark, env=env)
...
if __name__ == '__main__':
    job_run_gold_dim_subscriptions()
