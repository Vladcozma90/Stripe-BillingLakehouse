...
def job_run_gold_fact_stripe_subscription_items() -> None:
    ...
    try:
        run_gold_fact_stripe_subscription_items(spark=spark, env=env)
...
if __name__ == '__main__':
    job_run_gold_fact_stripe_subscription_items()
