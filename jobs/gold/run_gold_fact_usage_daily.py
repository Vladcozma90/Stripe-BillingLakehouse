...
from src.pipelines.gold.gold_fact_usage_daily import run_gold_fact_usage_daily
...
def job_run_gold_fact_usage_daily() -> None:
    ...
    try:
        run_gold_fact_usage_daily(spark=spark, env=env)
