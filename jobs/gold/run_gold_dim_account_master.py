...
from src.pipelines.gold.gold_dim_account_master import run_gold_dim_account_master
...
def job_run_gold_dim_account_master() -> None:
    ...
    try:
        run_gold_dim_account_master(spark=spark, env=env)
...
if __name__ == '__main__':
    job_run_gold_dim_account_master()
